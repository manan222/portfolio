...
export default function ProfileImage() {
  return (
    ...
    >
      ...
      <div className="relative h-[360px] w-[360px] overflow-hidden rounded-full border border-white/10 bg-[#111827] shadow-2xl lg:h-[430px] lg:w-[430px]">
      ...
      >
        <h4 className="gradient-text text-lg font-bold">
          React Expert
        </h4>
